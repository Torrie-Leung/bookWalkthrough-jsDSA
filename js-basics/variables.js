var num = 1; //declare a variable, initialize it with a number
num = 3;// and then update it with a string or any other datatype

var price = 1.5//declare a decimal floating point
